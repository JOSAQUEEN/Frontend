...
import { HiAtSymbol,HiFingerPrint,HiEyeOff, HiOutlineAcademicCap, HiOutlineUser } from "react-icons/hi";
...
export default function Register(){
    ...
    <section className='w-3/4 mx-auto flex flex-col gap-10'>
            ...
            <p className='text-center text-gray-400'>
                Have an account? 
            <Link href={'/login'}>
            <legacyBehavior className='text-blue-700'>Sign In</legacyBehavior>
            </Link>
            </p>
        </section>
        </Layout>
